...
const Lobby = () => {
    ...
    if (mode === 'create') {
        return (
            <>
                <SEOHead
                    title="Crear Sala - Impostor Game"
                    description="Crea una sala privada de Impostor y juega con tus amigos. Serás el administrador. ¡Gratis y sin registro!"
                    keywords="crear sala impostor, juego multijugador privado, sala de juegos"
                    image="/og-image-create.png"
                    url="https://impostor.lat"
                />
    ...
    if (mode === 'join') {
        return (
            <>
                <SEOHead
                    title="Unirse a Sala - Impostor Game"
                    description="Únete a una sala de Impostor con el código de tu amigo. Juega multijugador online gratis."
                    keywords="unirse sala impostor, código sala, juego multijugador"
                    image="/og-image-join.png"
                    url="https://impostor.lat"
                />
                <div className="bg-white rounded-3xl shadow-2xl p-8 md:p-12">
                    <button
