...
const Voting = () => {
    ...
    return (
        <>
            <SEOHead
                title="Votación - ¿Quién es el Impostor? | Impostor Game"
                description="Es hora de votar. ¿Quién crees que es el impostor? Elige sabiamente para ganar la ronda."
                keywords="votación impostor, deducción, juego estrategia"
                image="/og-image-voting.png"
