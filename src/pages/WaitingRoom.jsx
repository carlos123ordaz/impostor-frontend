...
const WaitingRoom = () => {
    ...
    return (
        <>
            <SEOHead
                title={`Sala ${room?.roomCode} - Esperando Jugadores | Impostor Game`}
                description={`Sala de Impostor con ${room?.players.length} jugadores. Código: ${room?.roomCode}. Invita a más amigos para comenzar.`}
                keywords="sala impostor, esperando jugadores, juego multijugador"
                image="/og-image-waiting.png"
