...
const Playing = () => {
    ...
    return (
        <>
            <SEOHead
                title={`Ronda en Juego - ${role?.isImpostor ? 'Impostor' : 'Jugador'} | Impostor Game`}
                description="Eres parte de una ronda de Impostor. Encuentra al impostor o engaña a los demás. ¡Que comience la diversión!"
                keywords="juego impostor, deducción, estrategia, juego online"
                image="/og-image-playing.png"
                url={`https://impostor.lat/game/${room?.roomCode}`}
                type="article"
            />
