...
const RoleReveal = () => {
    ...
    return (
        <>
            <SEOHead
                title={role?.isImpostor ? "¡Eres el Impostor!" : "¡Eres Jugador!"}
                description={role?.isImpostor
                    ? "Tu rol: Impostor. Intenta no ser descubierto. La palabra es: " + role.hint
                    : "Tu rol: Jugador. Encuentra al impostor. La palabra es: " + role.word
                }
                keywords="rol asignado, impostor, jugador, estrategia"
                image="/og-image-role.png"
                type="article"
            />
